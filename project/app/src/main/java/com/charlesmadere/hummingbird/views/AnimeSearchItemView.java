...
public class AnimeSearchItemView extends CardView implements AdapterView<AbsAnime>,
    ...
    public AnimeSearchItemView(final Context context, final AttributeSet attrs) {
        super(context, attrs);
    }
