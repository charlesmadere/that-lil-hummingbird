...
public interface KitsuApi {
    ...
    @GET("feeds/global/global?include=media,actor,unit,subject,target,target.user.user_roles.role,target.target_user.user_roles.role,target.spoiled_unit,target.media,subject.user.user_roles.role,subject.target_user.user_roles.role,subject.spoiled_unit,subject.media,subject.media,subject.follower,subject.followed,subject.library_entry&page[limit]=10")
