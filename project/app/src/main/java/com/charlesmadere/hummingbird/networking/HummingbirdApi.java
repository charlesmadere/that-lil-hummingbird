...
public interface HummingbirdApi {
    ...
    Call<ArrayList<AnimeV1>> getFavoriteAnime(@Path("username") String username);
    ...
    @GET("v1/search/anime")
    Call<ArrayList<AnimeV1>> searchAnimeByTitle(@Query("query") String query);
    ...
    @GET("v2/anime/{id}")
    Call<AnimeV2> getAnimeById(@Path("id") String id);

    @GET("v2/anime/myanimelist:{malid}")
    Call<AnimeV2> getAnimeByMyAnimeListId(@Path("malid") String malid);
