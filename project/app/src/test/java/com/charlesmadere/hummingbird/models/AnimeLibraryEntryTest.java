...
public class AnimeLibraryEntryTest {
    ...
    public static AnimeLibraryEntry get() throws Exception {
        final AnimeLibraryEntryTest test = new AnimeLibraryEntryTest();
        test.setUp();
    ...
    public void setUp() throws Exception {
        mLibraryEntry = GsonUtils.getGson().fromJson(JSON_LIBRARY_ENTRY, AnimeLibraryEntry.class);
    }
    ...
    public void testHasRating() throws Exception {
        assertTrue(mLibraryEntry.hasRating());
    }
