...
public class MangaLibraryEntryTest {
    ...
    private static MangaLibraryEntry sLibraryEntry;


    public static MangaLibraryEntry get() {
        if (sLibraryEntry == null) {
            sLibraryEntry = GsonUtils.getGson().fromJson(JSON_LIBRARY_ENTRY, MangaLibraryEntry.class);
        }
